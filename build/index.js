...
const context$2 = /*#__PURE__*/React__namespace.createContext({});
...
const AccordionBody = /*#__PURE__*/React__namespace.forwardRef(({
  ...
  return /*#__PURE__*/jsxRuntime.jsx(AccordionCollapse$1, {
    eventKey: eventKey,
    onEnter: onEnter,
...
const AccordionHeader = /*#__PURE__*/React__namespace.forwardRef(({
  ...
  return /*#__PURE__*/jsxRuntime.jsx(Component, {
    ...
    ...props,
    className: classNames(className, bsPrefix),
    children: /*#__PURE__*/jsxRuntime.jsx(AccordionButton$1, {
      onClick: onClick,
      children: children
    })
  });
...
const AccordionItem = /*#__PURE__*/React__namespace.forwardRef(({
  ...
  return /*#__PURE__*/jsxRuntime.jsx(AccordionItemContext.Provider, {
    value: contextValue,
    children: /*#__PURE__*/jsxRuntime.jsx(Component, {
      ref: ref,
      ...props,
...
const Accordion$1 = /*#__PURE__*/React__namespace.forwardRef((props, ref) => {
  const {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component = 'div',
    activeKey,
...
const Alert = /*#__PURE__*/React__namespace.forwardRef((uncontrolledProps, ref) => {
  ...
  const alert = /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    children: [dismissible && /*#__PURE__*/jsxRuntime.jsx(CloseButton$1, {
      onClick: handleClose,
...
const Carousel$1 = /*#__PURE__*/React__namespace.forwardRef(({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(Component, {
    ...
    children: [indicators && /*#__PURE__*/jsxRuntime.jsx("div", {
      ...
      children: map(children, (child, index) => {
        ...
        return slide ? /*#__PURE__*/jsxRuntime.jsx(TransitionWrapper$1, {
          in: isActive,
          onEnter: isActive ? handleEnter : undefined,
          onEntered: isActive ? handleEntered : undefined,
          addEndListener: transitionEndListener,
          children: (status, innerProps) => /*#__PURE__*/React__namespace.cloneElement(child, {
            ...innerProps,
      ...
      children: [(wrap || activeIndex !== 0) && /*#__PURE__*/jsxRuntime.jsxs(Anchor$1, {
      ...
      }), (wrap || activeIndex !== numChildren - 1) && /*#__PURE__*/jsxRuntime.jsxs(Anchor$1, {
...
const Image$3 = /*#__PURE__*/React__namespace.forwardRef(({
  bsPrefix,
  className,
  fluid = false,
  rounded = false,
...
const FigureImage = /*#__PURE__*/React__namespace.forwardRef(({
  ...
  fluid = true,
  ...props
}, ref) => /*#__PURE__*/jsxRuntime.jsx(Image$4, {
  ref: ref,
  ...props,
  fluid: fluid,
...
var __GenericLayout = function (props) {
    var genericSections = Object.keys(props.pageTemplate).map(function (sectionName) {
        return React__default["default"].createElement("section", { key: sectionName, className: sectionName },
            React__default["default"].createElement(section, { name: sectionName, pageTemplate: props.pageTemplate, pageProps: props.pageProps }));
    });
    return React__default["default"].createElement("div", { className: 'backendlayout-' + props.pageProps.headlessData.appearance.backendLayout }, genericSections);
};
...
var RenderContent = function (contentData, pageProps) {
    ...
    return React__default["default"].createElement(React__default["default"].Fragment, { key: contentData.id }, layout({ children: template(contentData, pageProps), content: contentData }));
}; //, args: _args
...
var Header$1 = function (props) {
    ...
    switch (props.layout) {
        case 1:
            return React__default["default"].createElement("h1", { className: cssClass + ' ' + props.positionClass },
        ...
        case 3:
            return React__default["default"].createElement("h3", { className: cssClass + ' ' + props.positionClass },
                React__default["default"].createElement(HeaderLink, { headerLink: props.headerLink },
                    React__default["default"].createElement("span", null, props.header)));
        case 4:
            return React__default["default"].createElement("h4", { className: cssClass + ' ' + props.positionClass },
                React__default["default"].createElement(HeaderLink, { headerLink: props.headerLink },
                    React__default["default"].createElement("span", null, props.header)));
        case 5:
            return React__default["default"].createElement("h5", { className: cssClass + ' ' + props.positionClass },
                React__default["default"].createElement(HeaderLink, { headerLink: props.headerLink },
                    React__default["default"].createElement("span", null, props.header)));
        case 100:
            return React__default["default"].createElement(React__default["default"].Fragment, null);
        default:
            return React__default["default"].createElement("h2", { className: cssClass + ' ' + props.positionClass },
                React__default["default"].createElement(HeaderLink, { headerLink: props.headerLink },
                    React__default["default"].createElement("span", null, props.header)));
    }
};
        ...
        case 4:
            return React__default["default"].createElement("h5", { className: cssClass + ' ' + props.positionClass },
                React__default["default"].createElement(HeaderLink, { headerLink: props.headerLink },
                    React__default["default"].createElement("span", null, props.header)));
        case 5:
            return React__default["default"].createElement("h6", { className: cssClass + ' ' + props.positionClass },
                React__default["default"].createElement(HeaderLink, { headerLink: props.headerLink },
                    React__default["default"].createElement("span", null, props.header)));
        case 100:
            return React__default["default"].createElement(React__default["default"].Fragment, null);
...
var Image$2 = function (props) {
    ...
    var imageContent = React__default["default"].createElement("picture", null,
        sources,
        React__default["default"].createElement(FigureImage$1, { loading: "lazy", className: cssClasses, src: publicUrl, title: (_a = properties.title) === null || _a === void 0 ? void 0 : _a.replace(/&quot;/gi, '"'), alt: properties.alternative }));
...
var Image$1 = function (props) {
    ...
    var caption = file.properties.description ?
        React__default["default"].createElement(Figure$1.Caption, { className: "caption" }, file.properties.description) : React__default["default"].createElement(React__default["default"].Fragment, null);
    return React__default["default"].createElement(Figure$1, { className: 'image' },
        ...
        Object.keys(props.data.gallery.rows).map(function (rowKey) {
            return Object.keys(props.data.gallery.rows[rowKey].columns).map(function (columnKey) {
                ...
                if (props.data.enlargeImageOnClick) {
                    colContent = React__default["default"].createElement("a", { onClick: function (e) {
                            e.preventDefault();
                ...
                return React__default["default"].createElement(Col$1, { className: "gallery-item  gallery-item-size-" + props.data.gallery.count.columns, key: rowKey + '-' + columnKey }, colContent);
            });
        }));
};
...
var Textpic = function (props) {
    ...
    return React__default["default"].createElement(Row$1, { className: "textpic textpic-" + textpicClassName },
        React__default["default"].createElement(Col$1, { className: "textpic-item textpic-gallery", md: textpicClassName === props.data.content.gallery.position.vertical ? "auto" : "6" },
            React__default["default"].createElement(Row$1, null,
                React__default["default"].createElement(ImageCols, { data: props.data.content }))),
        React__default["default"].createElement(Col$1, { className: "textpic-item textpic-text", md: "6" },
            React__default["default"].createElement(AllHeader, { data: props.data }),
...
var Textmedia = function (props) {
    ...
    return React__default["default"].createElement(Row$1, { className: "textmedia textmedia-" + textmediaClassName },
        React__default["default"].createElement(Col$1, { className: "textmedia-item textmedia-gallery", md: textmediaClassName === props.data.content.gallery.position.vertical ? "auto" : "6" },
            React__default["default"].createElement(Row$1, null, Object.keys(props.data.content.gallery.rows).map(function (rowKey) {
                return Object.keys(props.data.content.gallery.rows[rowKey].columns).map(function (columnKey) {
                    switch (props.data.content.gallery.rows[rowKey].columns[columnKey].properties.mimeType) {
                        case 'video/youtube':
                            return React__default["default"].createElement(Col$1, { className: "gallery-item  gallery-item-size-" + props.data.content.gallery.count.columns },
        ...
        React__default["default"].createElement(Col$1, { className: "textmedia-item textmedia-text" },
            React__default["default"].createElement(AllHeader, { data: props.data }),
            React__default["default"].createElement("div", { dangerouslySetInnerHTML: { __html: props.data.content.bodytext } }),
            props.children));
};
            ...
            React__default["default"].createElement("ul", { className: "media-list filelink-list" }, Object.keys(props.data.content.media).map(function (key) {
                ...
                switch (props.data.content.displayInformation) {
                    ...
                    case "2":
                        ...
                        content = React__default["default"].createElement(Row$1, null,
                            React__default["default"].createElement(Col$1, { className: 'filelink-media', xs: 3, sm: 3, md: 3, lg: 2, xl: 2, xxl: 2 }, media),
                            React__default["default"].createElement(Col$1, { className: 'filelink-body' },
                                heading(),
                                description));
                        break;
                    default:
...
var Type = function (props) {
    ...
    switch (fileType) {
        ...
        default:
            return React__default["default"].createElement(Alert$1, { variant: "info" },
                "Filetype unknown ",
...
var Gallery = function (props) {
    ...
    var galleryItems = items.map(function (image, index) {
        return React__default["default"].createElement(Col$1, { key: "".concat(index), className: "gallery-item gallery-item-size-".concat(imagecols), md: imagecols },
...
var Accordion = function (props) {
    ...
    var accorditionItemsTemplate = accordionItems.map(function (accordionItem, index) {
        ...
        if (accordionItem.media.length > 0) {
            galleryTemplate = React__default["default"].createElement(Gallery, { children: props.children, data: { content: __assign({ items: accordionItem.media }, accordionItem) } });
        }
        return React__default["default"].createElement(ReactAccordion.Item, { key: accordionItem.id, eventKey: accordionItem.id.toString() },
            React__default["default"].createElement(ReactAccordion.Header, { as: "h4", id: "accordion-heading-".concat(accordionItem.id) },
                React__default["default"].createElement("span", { className: "accordion-title-link-text" }, accordionItem.header)),
            React__default["default"].createElement(ReactAccordion.Body, null,
    ...
    return React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(AllHeader, { data: props.data }),
        React__default["default"].createElement(ReactAccordion, { defaultActiveKey: activeElement }, accorditionItemsTemplate),
        props.children);
};
...
var CardGroup = function (props) {
    ...
    var cards = items.map(function (cardData, index_number) {
        ...
        var imageTemplate = image ? image.map(function (imageData, index) { return React__default["default"].createElement(Card$1.Img, { key: "image-data-".concat(index), variant: "top", src: imageData.publicUrl }); }) : React__default["default"].createElement(React__default["default"].Fragment, null);
        ...
        return React__default["default"].createElement(Col$1, { key: "card-group-col-".concat(index_number) },
            React__default["default"].createElement(Card$1, null,
                header.length > 0 && React__default["default"].createElement(Card$1.Header, null, header),
                imageTemplate,
                React__default["default"].createElement(Card$1.Body, null,
                    subheader.length > 0 && React__default["default"].createElement(Card$1.Title, null, subheader),
                    bodytext.length > 0 && React__default["default"].createElement(Card$1.Text, { as: "div" },
                        React__default["default"].createElement("div", { dangerouslySetInnerHTML: { __html: bodytext } })),
                    linkButton)));
    });
    ...
    return React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(AllHeader, { data: props.data }),
        React__default["default"].createElement(Row$1, { xs: 1, md: flexform.columns, className: "card-group ".concat(alignment) }, cards),
        props.children);
};
    ...
    switch (itemType) {
        ...
        default:
            item = React__default["default"].createElement("div", { className: 'carousel-text-inner' },
                React__default["default"].createElement(Alert$1, { variant: "danger" },
                    React__default["default"].createElement(Alert$1.Heading, null, "Templatetype unknown"),
                    React__default["default"].createElement("p", null,
                        itemType,
                        " has no Template")));
    }
    return React__default["default"].createElement(Carousel$2.Item, { key: image[0].publicUrl, className: itemClass },
...
var Carousel = function (props) {
    ...
    return React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(AllHeader, { data: props.data }),
        React__default["default"].createElement(Carousel$2, { fade: flexform.transition === 'fade', interval: flexform.interval, wrap: flexform.wrap }, itemsTemplate));
};
        ...
        return React__default["default"].createElement("div", { key: link, className: "card-menu-item ".concat((thumbnail && ((_a = thumbnail[0]) === null || _a === void 0 ? void 0 : _a.publicUrl) ? 'hasImage' : 'noImage')) },
            React__default["default"].createElement(Card$1, null,
                thumbnail && thumbnail.length > 0 &&
                    React__default["default"].createElement(Card$1.Link, { href: link, target: target, title: title, "data-toggle": "tooltip" },
                        React__default["default"].createElement(Card$1.Img, { variant: "top", src: thumbnail[0].publicUrl })),
                React__default["default"].createElement(Card$1.Body, null,
                    title && title.length > 0 &&
                        React__default["default"].createElement(Card$1.Title, { as: 'h3' },
                            React__default["default"].createElement(Card$1.Link, { href: link, target: target, title: title, "data-toggle": "tooltip" }, title)),
                    description &&
                        React__default["default"].createElement(Card$1.Text, { as: "p" }, description),
                    props.children),
                (readmoreLabel && readmoreLabel.length > 0) && React__default["default"].createElement(Card$1.Footer, null,
                    React__default["default"].createElement(Card$1.Link, { href: link, target: target, title: title, "data-toggle": "tooltip" }, readmoreLabel))));
    });
    return React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(AllHeader, { data: props.data }),
...
var FooterContent = function (_a) {
    ...
    return React__default["default"].createElement("footer", { className: "section footer-section footer-section-content" },
        React__default["default"].createElement(Container$1, null,
            React__default["default"].createElement(Row$1, null,
                React__default["default"].createElement(Col$1, { className: "footer-section-content-column footer-section-content-column-left" },
                    React__default["default"].createElement(Content, { colPos: '10', pageProps: pageProps })),
                React__default["default"].createElement(Col$1, { className: " footer-section-content-column footer-section-content-column-middle" },
                    React__default["default"].createElement(Content, { colPos: '11', pageProps: pageProps })),
                React__default["default"].createElement(Col$1, { className: " footer-section-content-column footer-section-content-column-right" },
                    React__default["default"].createElement(Content, { colPos: '12', pageProps: pageProps })))));
};
...
var getGridElement = function (element, pageProps, index) {
    ...
    switch (element.type) {
        case 'row':
            ...
            return React__default["default"].createElement(Row$1, { as: (_a = element.tag) !== null && _a !== void 0 ? _a : 'div', key: index }, children);
        case 'col':
            return React__default["default"].createElement(Col$1, { as: (_b = element.tag) !== null && _b !== void 0 ? _b : 'div', lg: element.colspan, md: element.colspan, sm: element.colspan, xl: element.colspan, key: index },
                React__default["default"].createElement(Content, { colPos: element.colPos, pageProps: pageProps }));
        default:
            return React__default["default"].createElement(React__default["default"].Fragment, null);
    }
};
...
var pageLayouts = {
    ...
    'layout-0': function (pageProps, pageTemplate) { return React__default["default"].createElement("div", { className: 'backendlayout-' + pageProps.headlessData.appearance.backendLayout },
        React__default["default"].createElement("header", null),
        React__default["default"].createElement("section", null,
            React__default["default"].createElement(section, { name: 'main', pageTemplate: pageTemplate, pageProps: pageProps })),
        React__default["default"].createElement("footer", null,
            React__default["default"].createElement(section, { name: 'footer', pageTemplate: pageTemplate, pageProps: pageProps }))); },
    __generic: function (pageProps, pageTemplate) { return React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(__GenericLayout, { pageProps: pageProps, pageTemplate: pageTemplate })); },
    Default: function (pageProps, pageTemplate) { return React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(__GenericLayout, { pageProps: pageProps, pageTemplate: pageTemplate })); }
};
var pageTemplates = {
    __generic: function (pageProps) {
        return {
            main: React__default["default"].createElement(GenericPage, { pageProps: pageProps })
        };
    },
    default: function (pageProps) {
        return {
            border: React__default["default"].createElement(Row$1, null,
                React__default["default"].createElement(Col$1, null,
                    React__default["default"].createElement(Content, { colPos: '3', pageProps: pageProps }))),
            main: React__default["default"].createElement(React__default["default"].Fragment, null,
                React__default["default"].createElement(Row$1, null,
                    React__default["default"].createElement(Col$1, null,
                        React__default["default"].createElement(Content, { colPos: '8', pageProps: pageProps }))),
                React__default["default"].createElement("div", { className: "section section-default" },
                    React__default["default"].createElement(Row$1, null,
                        React__default["default"].createElement(Col$1, null,
                            React__default["default"].createElement(Content, { colPos: '0', pageProps: pageProps })))),
                React__default["default"].createElement(Row$1, null,
                    React__default["default"].createElement(Col$1, null,
                        React__default["default"].createElement(Content, { colPos: '9', pageProps: pageProps })))),
            footer: React__default["default"].createElement(FooterContent, { pageProps: pageProps }),
        };
    },
        ...
        return {
            ...
            main: React__default["default"].createElement(React__default["default"].Fragment, null,
                ...
                React__default["default"].createElement("div", { className: "section section-default" },
                    React__default["default"].createElement(Container$1, null,
                        React__default["default"].createElement(Row$1, null,
                            React__default["default"].createElement(Col$1, { md: "8", as: "main", className: " maincontent-wrap", role: "main" },
                                React__default["default"].createElement(Content, { colPos: '0', pageProps: pageProps })),
                            React__default["default"].createElement(Col$1, { className: " subcontent-wrap ", md: "4" },
                                React__default["default"].createElement(Content, { colPos: '2', pageProps: pageProps }))))),
                React__default["default"].createElement(Row$1, null,
                    React__default["default"].createElement(Col$1, null,
                        React__default["default"].createElement(Content, { colPos: '9', pageProps: pageProps })))),
            footer: React__default["default"].createElement(FooterContent, { pageProps: pageProps }),
                    ...
                    React__default["default"].createElement(Container$1, null,
                        React__default["default"].createElement(Row$1, null,
                            React__default["default"].createElement(Col$1, { md: "8", as: "main", className: " maincontent-wrap", role: "main" },
                                React__default["default"].createElement(Content, { colPos: '0', pageProps: pageProps })),
                            React__default["default"].createElement(Col$1, { className: " subcontent-wrap", md: "4" },
                                React__default["default"].createElement(Content, { colPos: '1', pageProps: pageProps }))))),
                React__default["default"].createElement(Row$1, null,
                    React__default["default"].createElement(Col$1, null,
                        React__default["default"].createElement(Content, { colPos: '9', pageProps: pageProps })))),
            footer: React__default["default"].createElement(FooterContent, { pageProps: pageProps }),
        ...
        return {
            ...
            main: React__default["default"].createElement(React__default["default"].Fragment, null,
                ...
                React__default["default"].createElement("div", { className: "section section-default" },
                    React__default["default"].createElement(Container$1, null,
                        React__default["default"].createElement(Row$1, null,
                            React__default["default"].createElement(Col$1, { md: "6", as: "main", className: " maincontent-wrap", role: "main" },
                                React__default["default"].createElement(Content, { colPos: '0', pageProps: pageProps })),
                            React__default["default"].createElement(Col$1, { className: " subcontent-wrap ", md: "6" },
                                React__default["default"].createElement(Content, { colPos: '2', pageProps: pageProps }))))),
                React__default["default"].createElement(Row$1, null,
                    React__default["default"].createElement(Col$1, null,
                        React__default["default"].createElement(Content, { colPos: '9', pageProps: pageProps })))),
        ...
        return {
            ...
            main: React__default["default"].createElement(React__default["default"].Fragment, null,
                ...
                React__default["default"].createElement("div", { className: "section section-default" },
                    React__default["default"].createElement(Container$1, null,
                        React__default["default"].createElement(Row$1, null,
                            React__default["default"].createElement(Col$1, { lg: "6", as: "main", className: " maincontent-wrap ", role: "main" },
                                React__default["default"].createElement(Content, { colPos: '0', pageProps: pageProps })),
                            React__default["default"].createElement(Col$1, { className: " subcontent-wrap ", lg: "3" },
                                React__default["default"].createElement(Content, { colPos: '1', pageProps: pageProps })),
                            React__default["default"].createElement(Col$1, { className: " subcontent-wrap ", lg: "3" },
                                React__default["default"].createElement(Content, { colPos: '2', pageProps: pageProps }))))),
                React__default["default"].createElement(Row$1, null,
        ...
        return {
            ...
            main: React__default["default"].createElement(React__default["default"].Fragment, null,
                ...
                React__default["default"].createElement("div", { className: "section section-primary" },
                    React__default["default"].createElement(Container$1, null,
                        React__default["default"].createElement(Row$1, null,
                            React__default["default"].createElement(Col$1, { className: "section-column-half ", md: "6" },
                                React__default["default"].createElement(Content, { colPos: '30', pageProps: pageProps })),
                            React__default["default"].createElement(Col$1, { className: "section-column-half ", md: "6" },
                                React__default["default"].createElement(Content, { colPos: '31', pageProps: pageProps }))))),
                React__default["default"].createElement("div", { className: "section section-primary" },
                    React__default["default"].createElement(Container$1, null,
                        React__default["default"].createElement(Row$1, null,
                            React__default["default"].createElement(Col$1, { className: "section-column-half ", md: "6" },
                                React__default["default"].createElement(Content, { colPos: '32', pageProps: pageProps })),
                            React__default["default"].createElement(Col$1, { className: "section-column-half ", md: "6" },
                                React__default["default"].createElement(Content, { colPos: '33', pageProps: pageProps }))))),
                React__default["default"].createElement("div", { className: "section section-default" },
                    React__default["default"].createElement(Row$1, null,
                        React__default["default"].createElement(Col$1, null,
                            React__default["default"].createElement(Content, { colPos: '4', pageProps: pageProps })))),
                React__default["default"].createElement("div", { className: "section section-light" },
                    React__default["default"].createElement(Container$1, null,
                        React__default["default"].createElement(Row$1, null,
                            React__default["default"].createElement(Col$1, { className: "section-column-half ", md: "6" },
                                React__default["default"].createElement(Content, { colPos: '34', pageProps: pageProps })),
                            React__default["default"].createElement(Col$1, { className: "section-column-half ", md: "6" },
                                React__default["default"].createElement(Content, { colPos: '35', pageProps: pageProps }))))),
                React__default["default"].createElement("div", { className: "section section-light" },
                    React__default["default"].createElement(Container$1, null,
                        React__default["default"].createElement(Row$1, null,
                            React__default["default"].createElement(Col$1, { className: "section-column-half ", md: "6" },
                                React__default["default"].createElement(Content, { colPos: '36', pageProps: pageProps })),
                            React__default["default"].createElement(Col$1, { className: "section-column-half ", md: "6" },
                                React__default["default"].createElement(Content, { colPos: '37', pageProps: pageProps }))))),
                React__default["default"].createElement(Row$1, null,
                    React__default["default"].createElement(Col$1, null,
                        React__default["default"].createElement(Content, { colPos: '9', pageProps: pageProps })))),
            footer: React__default["default"].createElement(FooterContent, { pageProps: pageProps }),
        ...
        return {
            ...
            main: React__default["default"].createElement(React__default["default"].Fragment, null,
                ...
                React__default["default"].createElement("div", { className: "section section-default" },
                    React__default["default"].createElement(Container$1, null,
                        React__default["default"].createElement(Row$1, null,
                            React__default["default"].createElement(Col$1, { className: "section-column-third ", md: "4" },
                                React__default["default"].createElement(Content, { colPos: '20', pageProps: pageProps })),
                            React__default["default"].createElement(Col$1, { className: "section-column-third ", md: "4" },
                                React__default["default"].createElement(Content, { colPos: '21', pageProps: pageProps })),
                            React__default["default"].createElement(Col$1, { className: "section-column-third ", md: "4" },
                                React__default["default"].createElement(Content, { colPos: '22', pageProps: pageProps }))))),
                React__default["default"].createElement("div", { className: "section section-light" },
                    React__default["default"].createElement(Row$1, null,
                        React__default["default"].createElement(Col$1, null,
                            React__default["default"].createElement(Content, { colPos: '0', pageProps: pageProps })))),
...
var contentElementTemplates = {
    ...
    text: function (headlessContentData, pageProps) { return React__default["default"].createElement(Text, { data: headlessContentData, children: headlessContentData.children, pageProps: pageProps }); },
    html: function (headlessContentData, pageProps) { return React__default["default"].createElement(Html, { data: headlessContentData, children: headlessContentData.children, pageProps: pageProps }); },
    textpic: function (headlessContentData, pageProps) { return React__default["default"].createElement(Textpic, { data: headlessContentData, children: headlessContentData.children, pageProps: pageProps }); },
    image: function (headlessContentData, pageProps) { return React__default["default"].createElement(Image, { data: headlessContentData, children: headlessContentData.children, pageProps: pageProps }); },
    shortcut: function (headlessContentData, pageProps) { return React__default["default"].createElement(Shortcut, { data: headlessContentData, children: headlessContentData.children, pageProps: pageProps }); },
    div: function (headlessContentData, pageProps) { return React__default["default"].createElement(Div, { data: headlessContentData, children: headlessContentData.children, pageProps: pageProps }); },
    uploads: function (headlessContentData, pageProps) { return React__default["default"].createElement(Uploads, { data: headlessContentData, children: headlessContentData.children, pageProps: pageProps }); },
    accordion: function (headlessContentData, pageProps) { return React__default["default"].createElement(Accordion, { data: headlessContentData, children: headlessContentData.children, pageProps: pageProps }); },
    gallery: function (headlessContentData, pageProps) { return React__default["default"].createElement(Gallery, { data: headlessContentData, children: headlessContentData.children, pageProps: pageProps }); },
    textmedia: function (headlessContentData, pageProps) { return React__default["default"].createElement(Textmedia, { data: headlessContentData, children: headlessContentData.children, pageProps: pageProps }); },
    card_group: function (headlessContentData, pageProps) { return React__default["default"].createElement(CardGroup, { data: headlessContentData, children: headlessContentData.children, pageProps: pageProps }); },
    textcolumn: function (headlessContentData, pageProps) { return React__default["default"].createElement(TextColumns, { data: headlessContentData, children: headlessContentData.children, pageProps: pageProps }); },
    quote: function (headlessContentData, pageProps) { return React__default["default"].createElement(Quote, { data: headlessContentData, children: headlessContentData.children, pageProps: pageProps }); },
    header: function (headlessContentData, pageProps) { return React__default["default"].createElement(Header, { data: headlessContentData, children: headlessContentData.children, pageProps: pageProps }); },
    carousel: function (headlessContentData, pageProps) { return React__default["default"].createElement(Carousel, { data: headlessContentData, children: headlessContentData.children, pageProps: pageProps }); },
    menu_card_list: function (headlessContentData, pageProps) { return React__default["default"].createElement(MenuCardList, { data: headlessContentData, children: headlessContentData.children, pageProps: pageProps }); },
    menu_card_dir: function (headlessContentData, pageProps) { return React__default["default"].createElement(MenuCardDir, { data: headlessContentData, children: headlessContentData.children, pageProps: pageProps }); },
    menu_thumbnail_dir: function (headlessContentData, pageProps) { return React__default["default"].createElement(MenuThumbnailBase, { data: headlessContentData, children: headlessContentData.children, pageProps: pageProps }); },
    menu_thumbnail_list: function (headlessContentData, pageProps) { return React__default["default"].createElement(MenuThumbnailBase, { data: headlessContentData, children: headlessContentData.children, pageProps: pageProps }); },
...
var TYPO3Page = function (props) {
    ...
    return React__default["default"].createElement(Page, { pageProps: {
